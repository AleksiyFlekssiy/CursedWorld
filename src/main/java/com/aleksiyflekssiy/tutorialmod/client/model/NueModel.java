...
public class NueModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftWing = body.addOrReplaceChild("leftWing", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.0F, 8.0F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = head.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(74, 0).addBox(-5.0F, -12.0F, -1.0F, 6.0F, 12.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -37.0F, -13.0F, 0.0F, 0.4363F, 0.0F));
