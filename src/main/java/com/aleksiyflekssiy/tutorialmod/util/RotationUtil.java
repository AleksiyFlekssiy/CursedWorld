...
public class RotationUtil {
    public static Vec3 getOffsetLookPosition(Player player, Vec3 lookPos, double rightOffset, double upOffset,
                                       double forwardOffset) {
        Vec3 lookVec = player.getLookAngle().normalize(); // Вектор взгляда (вперёд)
