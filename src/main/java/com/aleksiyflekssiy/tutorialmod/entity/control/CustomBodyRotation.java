...
public class CustomBodyRotation extends BodyRotationControl {
    private final Mob mob;
    private static final int HEAD_STABLE_ANGLE = 0;
    private static final int DELAY_UNTIL_STARTING_TO_FACE_FORWARD = 0;
    private static final int HOW_LONG_IT_TAKES_TO_FACE_FORWARD = 0;
    private int headStableTime;
    private float lastStableYHeadRot;

    public CustomBodyRotation(Mob entity) {
        super(entity);
        this.mob = entity;
    }
    /**
