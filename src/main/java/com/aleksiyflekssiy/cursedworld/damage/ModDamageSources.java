package com.aleksiyflekssiy.cursedworld.damage;
...
public class ModDamageSources {
    public static final ResourceKey<DamageType> INFINITY = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "infinity"));
    public static final ResourceKey<DamageType> BLUE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "blue"));
    public static final ResourceKey<DamageType> RED = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "red"));
    public static final ResourceKey<DamageType> HOLLOW_PURPLE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "hollow_purple"));
