package com.aleksiyflekssiy.cursedworld.registry;
...
public class Skills {
    public static ResourceKey<? extends Registry<Skill>> SKILL_REGISTRY_KEY =
            ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "skill"));
    public static final DeferredRegister<Skill> SKILLS = DeferredRegister.create(SKILL_REGISTRY_KEY, CursedWorld.MOD_ID);
    ...
    public static final RegistryObject<Skill> PIERCING_OX = registerSkill(new PiercingOx());
