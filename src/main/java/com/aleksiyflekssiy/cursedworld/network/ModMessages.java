...
public class ModMessages {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
            ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void register() {
        ...
        INSTANCE.registerMessage(id++, AddAABBToRenderPacket.class,
                AddAABBToRenderPacket::encode,
                AddAABBToRenderPacket::decode,
                AddAABBToRenderPacket::handle);

        INSTANCE.registerMessage(id++, AddOBBToRenderPacket.class,
                AddOBBToRenderPacket::encode,
                AddOBBToRenderPacket::decode,
                AddOBBToRenderPacket::handle);
    }
}
