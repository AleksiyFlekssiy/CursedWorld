...
import com.aleksiyflekssiy.cursedworld.client.model.HollowPurpleModel;
import com.aleksiyflekssiy.cursedworld.client.model.ModModelLayers;
import com.aleksiyflekssiy.cursedworld.entity.HollowPurpleEntity;
...
public class HollowPurpleRenderer extends EntityRenderer<HollowPurpleEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/hollow_purple_entity.png");
    private static final RenderType GLOW_RENDER_TYPE = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/hollow_purple_glow.png"));
    ...
    public ResourceLocation getTextureLocation(HollowPurpleEntity hollowPurpleEntity) {
        return ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/hollow_purple_glow.png");
    }
