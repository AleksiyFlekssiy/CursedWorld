...
import com.aleksiyflekssiy.cursedworld.client.model.RedModel;
import com.aleksiyflekssiy.cursedworld.entity.RedEntity;
...
public class RedRenderer extends EntityRenderer<RedEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/red_entity.png");
    private static final RenderType GLOW_RENDER_TYPE = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/red_entity.png"));
