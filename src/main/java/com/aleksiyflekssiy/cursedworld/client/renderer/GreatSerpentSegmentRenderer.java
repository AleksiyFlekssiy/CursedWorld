...
import com.aleksiyflekssiy.cursedworld.client.model.GreatSerpentSegmentModel;
...
public class GreatSerpentSegmentRenderer extends MobRenderer<GreatSerpentSegment, GreatSerpentSegmentModel<GreatSerpentSegment>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/great_serpent_segment.png");
