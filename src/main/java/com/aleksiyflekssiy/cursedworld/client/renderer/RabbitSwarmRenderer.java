...
import com.aleksiyflekssiy.cursedworld.cursed_technique.skill.tenshadows.RabbitEscape;
...
public class RabbitSwarmRenderer {
    ...
    public static void onRenderLevel(RenderLevelStageEvent event) {
        if (event.getStage() != RenderLevelStageEvent.Stage.AFTER_ENTITIES || ID_RENDER_TARGETS.isEmpty()) return;
        ...
        for (int id : ID_RENDER_TARGETS.keySet()) {
            ...
            for (int i = 0; i < MODEL_COUNT; i++) {
                ...
                RABBIT_MODEL.renderToBuffer(
                        poseStack,
                        buffer.getBuffer(RenderType.entityCutoutNoCull(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "textures/entity/rabbit_escape.png"))),
                        15728880,
