...
public class GreatSerpentHeadModel<T extends GreatSerpentEntity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "great_serpent_head"), "main");
