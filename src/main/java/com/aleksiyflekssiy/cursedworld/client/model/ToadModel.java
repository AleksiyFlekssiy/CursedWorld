package com.aleksiyflekssiy.cursedworld.client.model;// Made with Blockbench 5.0.7
...
public class ToadModel<T extends ToadEntity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "toad"), "main");
