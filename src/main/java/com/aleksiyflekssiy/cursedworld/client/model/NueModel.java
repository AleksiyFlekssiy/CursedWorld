package com.aleksiyflekssiy.cursedworld.client.model;// Made with Blockbench 4.12.4
...
public class NueModel<T extends NueEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(CursedWorld.MOD_ID, "nue"), "main");
