...
public class RabbitEscapeAI {
    public static Brain<RabbitEscapeEntity> makeBrain(Brain<RabbitEscapeEntity> brain) {
    ...
    protected static void initializeCoreActivity(Brain<RabbitEscapeEntity> brain){
        brain.addActivity(Activity.CORE, 0, ImmutableList.of(
                new CustomMoveToTarget(Map.of(MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_PRESENT))
        ));
    }

    protected static void initializeIdleActivity(Brain<RabbitEscapeEntity> brain){
        brain.addActivityWithConditions(Activity.IDLE,
                ImmutableList.of(
                        Pair.of(0, ShikigamiFollowOwner.create(25)),
    ...
    public static void updateActivity(Brain<RabbitEscapeEntity> brain){
