package com.aleksiyflekssiy.cursedworld.entity.navigation;
...
public class MMPathFinder extends PathFinder {
    ...
    static class PatchedPath extends Path {
        ...
        public @NotNull Vec3 getEntityPosAtNode(Entity entity, int index) {
            ...
            double d0 = point.x + Mth.floor(entity.getBbWidth() + 1.0F) * 0.5D; //0.5D
            double d1 = point.y;
            double d2 = point.z + Mth.floor(entity.getBbWidth() + 1.0F) * 0.5D; //0.5D
